// Fix duplicate voices and ensure proper English/Hindi support
const FIXED_VOICES = [
  ...
  { name: 'James (Male)', value: 'James', language: 'en-GB', gender: 'male', quality: 'high', accent: 'British', description: 'Refined British male voice' },
  ...
  { name: 'Arjun (Male)', value: 'Arjun', language: 'hi-IN', gender: 'male', quality: 'high', accent: 'Indian', description: 'Confident Indian male voice' },
